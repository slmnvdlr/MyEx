...
public class MainFrame extends JFrame {
    ...
    public MainFrame(int width, int height){
        ...
        configureAndSetLayout(panel, cPanel); // конфигурируем и устанавливаем для формы layout, расставляя панели в нужные места
    ...
    private void createAndAddPainters(GraphxPanel graphxPanel){
        var painters = new Painter[] { // создаем массив рисовальщиков
                ...
                new FunctionPainter(PlaneManager.getPlane()) // инициализируем рисовальщика функции
                        .setFunction(
                                new ExplicitFunction()) // у рисовальщика функции устанавливаем функцию, график которой рисовальщик будет рисовать
};
    ...
    private void configureAndSetLayout(GraphxPanel graphxPanel, ControlPanel controlPanel){
